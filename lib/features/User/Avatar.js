...
export default function Avatar(props) {
    ...
    secondWeapons.forEach( (part, i, theArray) => { secondWeaponOptions.push( <option key={part} value={part}>{part}</option> ); });
    ...
    return (
        <div className="avatar">
            ...
            <input type="Button" value="Choose your destiny" onClick={handleClick} />
        </div>
        );
}
        ...
        <div id="test" style={{position: 'relative'}} onClickCapture={allClicks}>
           {/*<Test_QandA handleChange={handleChange} showAnswer={showAnswer} card={currentCard} answer={currentAnswer} category={currentCategory} />*/}
            <div id="areas">
                ...
                <textarea id="localAnswer" value={seeAnswer == true ? localAnswer : 'Click Show'} onChange={e => setLocalAnswer(e.target.value)} rows="20" cols="40" name="answer"></textarea>
            ...
            <div id="buttoncontrolgroup">
                ...
                <input type="button" id="review" name="review" onClick={() => dispatch(review())} value="Review" />
                <p>

    ...
    return (
        <div className="editcard-modal">
            <div className="editcard-modalContent"> 
                ...
                <textarea onChange={e => setLocalCard(e.target.value)} value={editcard.card} className="editcardmodal-card" ref={cardRef}/>
                <textarea onChange={e => setLocalAnswer(e.target.value)} value={editcard.answer} className="editcardmodal-answer" ref={ansRef}/>
                <input id="localCategory" value={editcard.category} onChange={e => setLocalCategory(e.target.value)} type="text" name="category" />

...
export const queries = {
    ...
    insertSession: `INSERT INTO UserSessions(
                                ...
                                points_added,
                                card_sets_added,
                                date,user_id) VALUES(?,?,?,?,?,?,CURRENT_TIME(),?);`
}

export const GREATWHITE_SIZE = { width: '280px', height: '135px'};
export const HAMMERHEAD_SIZE = { width: '280px', height: '135px'};
export const NINJA_SIZE = { width: '280px', height: '135px'};
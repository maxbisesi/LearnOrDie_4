...
class Home_UserInfo extends React.Component {
  ...
  renderRank(rank) {
    switch(rank) {
      case 'Guest': return <Recruit />;
      case 'Recruit': return <Recruit />;
      case 'Bucket Brigade': return <BucketBrigade />;
      case 'Harpoonist': return <Harpoonist />;
      case 'Free Diver': return <FreeDiver />;
      case 'Cage Master': return <CageMaster />;
      case 'The Bitten': return <TheBitten />;
      case 'Great White': throw new Error(' havent drawn it yet'); return;
      default: return null;
    }
  }

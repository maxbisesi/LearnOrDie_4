    ...
    return (
        <div id="test" style={{position: 'relative'}} onClickCapture={allClicks}>
           {/*<Test_QandA handleChange={handleChange} showAnswer={showAnswer} card={currentCard} answer={currentAnswer} category={currentCategory} />*/}
            <div id="areas">
                <textarea ref={cardRef} className="test-questionBox" id="localCard" value={localCard} onChange={e => setLocalCard(e.target.value)} rows="30" cols="60" name="card"></textarea>
                <textarea ref={ansRef} className="test-questionBox" id="localAnswer" value={seeAnswer == true ? localAnswer : 'Click Show'} onChange={e => setLocalAnswer(e.target.value)} rows="30" cols="60" name="answer"></textarea>
            ...
            <div id="buttoncontrolgroup">
                ...
                <input className="button" type="button" id="previous" name="whiffed" onClick={previousCard} value="Previous"/>

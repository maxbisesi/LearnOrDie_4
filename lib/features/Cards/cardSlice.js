...
const cardSlice = createSlice({
    ...
    initialState: { 
        ...
        categories: {},
        newCards: [],     
        currentCard:  { 'cardid':'GETSTARTED', 'card':`Welcome to LearnOrDie,\nGet Ready to Sink or Swim or be eaten alive,\nIf this is your first time it's going to be rough,\nGood Luck! Click either button to get started.`, 'answer':'', 'category':'', 'times_right':'', 'times_wrong':'', 'owner_id':'', 'fk_user_id':''},
        reviews: [],
        history: []
    },
    reducers: {

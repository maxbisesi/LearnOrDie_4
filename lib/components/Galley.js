...
class Galley extends React.Component {
  constructor(props) {
    ...
    for (let i = 0; i < pageone; i++) {
      ...
      this.pageOneCards.push(
        <tr className="galleyQuestion" key={card.cardid} data-cardid={card.cardid} onClick={this.handleCardClick} onMouseEnter={this.handleMouseEnter}>
          <td>{card.card}</td>
          <td>{card.category}</td>
          <td>{card.times_right}</td>
          <td>{card.times_wrong}</td>
        </tr>
      );
    }
  }
  ...
  handleCardClick(e) {
    console.log(`on click bubbles ? : ${e.bubbles}`);
    console.log(`TR`);
    const clickedID = e.currentTarget.getAttribute('data-cardid');
    console.log(`Clicke ID current target: ${clickedID}`);
      ...
      <div id="Galley" style={{ height: 1500 }}>
        ...
        <div className="sets">
          <div className="galleyTable" >
            ...
            <div style={{ position: 'absolute', top: 930, left: 30 }}>
            ...
            <div style={{ position: 'absolute', top: 930, left: 200 }}>
              <p id="pagenumber">1</p>
            </div>
            <br />
            {/* <div
              id="setbuttons"
              style={{ position: 'absolute', top: 780, left: 30, zIndex: 2 }}
            >
              <input id="addquestionstoset" type="button" value="Add" />
              <input id="deletequestion" type="button" value="Delete" />
            </div> */}

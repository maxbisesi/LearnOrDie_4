...
When('The user clicks the {string} button {number} times', { timeout: 8000 }, async function(buttonname,times) {
...
When('The user waits {string} seconds',{ timeout: 50000 }, async function(seconds) {

...
export default function Main(props) {
    ...
    const {points, streak, rut, streakClass, nailed, whiffed, started: false} = useSelector(state => state.testSlice.session, shallowEqual);
    // Use Slice
    ...
    useBeforeunload( async (event) => {
        ...
        else { await axios.post('/saveSession',{'session':userSesh}); }
    });

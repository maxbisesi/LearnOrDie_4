  ...
  render() {
    return (
      <div className="galley">
        ...
        <div className="galley-popup">
            <p>Are you sure you want to delete?</p>
            <p>{this.clickedQuestions}</p>
            <div>
                <input className="galley-popup-button-yes" type="button" value="Argh!" onClick={this.deleteCards} />
                <input className="galley-popup-button-no" type="button" value="No" onClick={this.closeModal} />
            </div>
        </div>
      </div>
    );

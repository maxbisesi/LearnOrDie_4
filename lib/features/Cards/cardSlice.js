...
const cardSlice = createSlice({
    ...
    reducers: {
        ...
        saveForReview (state, action) {
            if(!state.reviews.some((c) => c.card_id === state.currentCard.card_id)){ 
...
export const { next, addCard, fillCategories, update, saveForReview, review, setCards, fillSets, pushCards} = cardSlice.actions;

...
const gameSlice = createSlice({
    ...
    reducers: {
        ...
        changeUrchinPosition(state,action) {
            state.urchinPosition = action.payload.urchinPosition;
        }
    }
});

export const { changePlayerPosition, changeUrchinPosition } = gameSlice.actions;

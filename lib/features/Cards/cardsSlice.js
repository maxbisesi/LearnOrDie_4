...
const cardSlice = createSlice({
    ...
    addCard(state, action) { 
        ...
        console.log(`addCard: cardsSlice -> card: ${action.payload.card.card} - card: ${action.payload.card.answer}`)
...
export const { next, addCard, fillCategories, update, setCards} = cardSlice.actions;

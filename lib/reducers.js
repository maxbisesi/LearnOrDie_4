...
const initialState = { 
    ...
    categoryNames: {},
    cards: [
    {card:"card1", answer: "an1", category: "cat1"},
    {card:"card2", answer: "an2", category: "cat2"},
    {card:"card3", answer: "an3", category: "cat3"}],
    currentCard: 0
};
...
export default function fcs(state = initialState, action) { 
    switch(action.type) {
        ...
        case 'NEXT_CARD':
            return Object.assign({}, state, {currentCard: ++state.currentCard});
        default: 
            return state;
    }
}

...
export default function Login(props){
  ...
  <h1 id="BTTW" className="login-screen-title">Brave the treachorous Waters..</h1>
    <div className="login-screen-center">
      <form onSubmit={handleSubmit}>
        ...
        <input id="loginbutton"  type="submit" title="submit" value="Login" className="login-loginbutton" />
        <input id="comeaboard"  onClick={(e) => { setStatus('Registering'); }} type="button" value="Come Aboard" className="login-loginbutton" />
      </form>

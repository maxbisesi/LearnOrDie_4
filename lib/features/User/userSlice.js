...
const userSlice = createSlice({
  ...
  initialState: {
    ...
    session: { cards_seen:0, correct:0, incorrect:0, 
              cards_added:0, points_added:0, card_sets_added:0, 
              'user_id':0, 'sets_studied':0,'sets_shared':0,'fins':0},
    // THE DATAAA, GIMMIE ALL THAT DATA -=-=-=-=-=-=-

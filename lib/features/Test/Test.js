...
export default function Test() {
    ...
    const { cardid, card, answer, category, correct, incorrect, owner_id} = useSelector( state => state.cardSlice.currentCard );
    ...
    const loggedIn = userSelector( state => state.userSlice.loggedIn);
    // Test Slice

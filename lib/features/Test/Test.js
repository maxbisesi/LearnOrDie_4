...
import { next, update, saveForReview, review, setCard } from '../Cards/cardSlice';
        ...
        <div id="test" style={{position: 'relative'}} onClickCapture={allClicks}>
           {/*<Test_QandA handleChange={handleChange} showAnswer={showAnswer} card={currentCard} answer={currentAnswer} category={currentCategory} />*/}
            ...
            <div id="buttoncontrolgroup">
                ...
                <input type="button" name="nailed" onClick={nextCard('nailed')} value="Nailed it"/>
                <input type="button" name="whiffed" onClick={nextCard('whiffed')} value="Missed it"/>

...
export default function Galley(props) {
    ...
    if( currentPage == pages) { 
        ...
        if(partialPage > 0) {
            ...
            pagelength = partialPage;
        }
    }
    // Now figure out what index to start at
    ...
    return (
      <div className="galley">
        ...
        <div className="galley-buttons-navigation">
          <input className="galley-button" type="button" value="<--|" onClick={(e) => setCurrentPage(prevPage => prevPage -1)} />

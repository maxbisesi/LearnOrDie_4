    ...
    return (
        <div className="editcard-modal">
            <div className="editcard-modalContent"> 
                ...
                <textarea id="editcardquestion" onChange={e => setLocalCard(e.target.value)} value={localCard} className="editcardmodal-card" ref={cardRef}/>
                <textarea id="editcardanswer" onChange={e => setLocalAnswer(e.target.value)} value={localAnswer} className="editcardmodal-answer" ref={ansRef}/>
                <input id="localCategory" value={localCategory} onChange={e => setLocalCategory(e.target.value)} type="text" name="category" />
                <input id="editcardsave" type="button" value="Save" onClick={() => update()} />
                <input id="editcardcancel" type="button" value="Cancel" onClick={() => props.setEditCardModal(false)} />
                <input id="editcardprevious" type="button" value="<-" />
                <input id="editcardnext" type="button" value="->" onClick={next} />
            </div>
        </div>
    );

...
const cardSlice = createSlice({
    ...
    reducers: {
        ...
        addCategoryToCollection(state,action) {
            ...
            const newColl = {};
            newColl[category] = state.categories[category];
            state.collections[collection] = newColl;
...
export const { next, addCard, fillCategories, update, saveForReview, review, setCards, fillSets, pushCards, filter, addSet, studySet, deleteCards, renameCategory, newCollection, addCategoryToCollection} = cardSlice.actions;

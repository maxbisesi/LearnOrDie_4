...
class Chum extends React.Component {
  ...
  handleSubmit(event) {
    ...
    this.addCard({card:this.state.card, answer:this.state.answer, category:this.state.category});
  ...
  render() {
    return (
      <div id="chum">
        <form id="chumForm" onSubmit={this.handleSubmit}>
          <div>
            <textarea
...
export default connect(mapDispatchToProps)(Chum);

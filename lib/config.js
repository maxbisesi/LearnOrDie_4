...
export const queries = {
    ...
    getUsersCards: `SELECT c.card_id, c.card, c.answer, c.category, c.owner_id, c.collection, fcu.correct, fcu.incorrect
    ...
    insertCardWithImage: `INSERT INTO FlashCards(card,answer,category,owner_id,image) VALUES(?,?,?,?,?)`,
    ...
    addCategoryToCollection: `Update FlashCards Set collection = ? Where category = ?`,

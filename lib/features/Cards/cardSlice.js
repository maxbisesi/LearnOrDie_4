...
const cardSlice = createSlice({
    ...
    reducers: {
        next(state, action) {
            ...
            // if(result === 'GETSTARTED') { state.currentCard = state.cards[0]; return;}
        ...
        setCard(state, action) { state.currentCard = state.cards[state.index]; },
        addCard(state, action) { 
            ...
            const cardid = state.tempNewCardId;

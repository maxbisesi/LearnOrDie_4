...
import { filter, asyncDeleteCards,  asyncRenameCategory, newCollection, asyncAddCategoryToCollection } from '../../Cards/cardSlice';
      ...
      if(checkedCats.length > 0) {
        if(confirm('Are you sure you want to permenantly delete all the questions in these categories ?') === true){
          ...
          for(let c = 0; c < checkedCats.length; c++) {
            ...
            deleteCards.push(categories[checkedCats[c]]);
          }

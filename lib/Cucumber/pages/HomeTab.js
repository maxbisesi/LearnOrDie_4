...
export default class HomeTab extends TemplatePage {
    ...
    async validateCategoriesInCollection(collection,cats) {
        const col = this.collections.get(collection);
        logger(`validateCategoriesInCollection: ${JSON.stringify(col)}`);
        logger(JSON.stringify(cats));
        return true;
    }

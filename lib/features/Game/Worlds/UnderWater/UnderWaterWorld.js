...
export default function UnderWaterWorld(props) {
    ...
    return (
        <div className="underwater-layer layer-1" onMouseMove={handleMouseMove}>
            <div className="underwater-layer layer-2">
                <div className="underwater-layer layer-3">
                    <div className="underwater-layer layer-4">
                        <div className="underwater-layer layer-5">

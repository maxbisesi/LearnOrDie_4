    ...
    return (
      <div className="home-categories">
        <div className="home-category_buttons">
          <input className="home-button" type="button" value="Filter" onClick={filter}/>
          <input className="home-button" type="button" value="Remove Filter" onClick={() => dispatch(filter('Remove'))} />

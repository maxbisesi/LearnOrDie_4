...
const cardSlice = createSlice({
    ...
    reducers: {
        ...
        addCard(state, action) { 
            const {card,answer,category,owner_id} = action.payload;
            ...
            state.cards.push({'cardid':undefined,'card':card,'answer':answer,'category':category,'owner_id':owner_id, 'correct':0, 'incorrect':0});

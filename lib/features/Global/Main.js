...
export default function Main(props) {
    ...
    useBeforeunload( async () => {
        if(user_id === 'GUESTID' || loggedIn === false) { 
            ...
            // Even if they close the window, keep them logged in. 
            // Leave this blank and they will still be able to come back even if
            // they close window and leave. Find out what happens if they close the browser. 
            // dispatch(logout()); 
            //await props.purge();
        }
    });

...
import GalleyQuestion from "../features/Cards/GalleyQuestion";

class GalleyDEP extends React.Component {
  constructor(props) {
    super(props);
...
export default connect(mapStateToProps, mapDispatchToProps)(GalleyDEP);
*/
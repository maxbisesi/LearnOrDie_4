...
export default function Galley(props) {
    ...
    return (
      <div className="galley">
        ...
        { editCardModal ? <EditCardModal setEditCardModal={setEditCardModal} /> : null  }
        <div className="galley-buttons-navigation">
          ...
          <input id="editcard" className="galley-button" type="button" value="Edit Card" onClick={(e) => setEditCardModal(true)} />

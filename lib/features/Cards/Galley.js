    ...
    return (
      <div className="galley">
        <div className="galley-buttons-navigation">
          ...
          <input className="galley-button" type="button" value="Delete Card" onClick={() => deleteCard()} />
          <input className="galley-button" type="button" value="Save to Set " onClick={() => setShowSetModal(true)} />
          <input className="galley-button" type="button" value="Edit Card" />
          <input className="galley-button" type="button" value="-->" onClick={(e) => changePage(e)} />
        </div>
        <div className="searchBoxContainer">
            <textarea className="searchBar" rows="1" onChange={(e) => setSearch(e.target.value)} />
